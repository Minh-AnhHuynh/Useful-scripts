<<<<<<< conflict 1 of 1
%%%%%%% diff from: kxzptqsr 8bd1af66 "Refactor backup script to improve file handling and add verification for successful copy" (parents of rebased revision)
\\\\\\\        to: yyolxzmy ed532584 "Add script to check for incomplete or missing extracted files in zip and 7z archives" (rebase destination)
...
+++++++ mrxpkysr c5d948ae (rebased revision)
﻿$process = Get-Process GoogleDriveFS -ErrorAction SilentlyContinue
